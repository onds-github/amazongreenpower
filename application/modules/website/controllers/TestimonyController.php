...
class Website_TestimonyController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->view->title_page = "Depoimentos";
        ...
        $this->view->headScript()
                ...
                ->appendFile("/public/modules/website/script.testimony.js");
    ...
    public function ajaxAction() {
        ...
        Zend_Loader::loadClass("Testimony");
        $model = new Testimony();
    ...
    public function updateAction() {
        ...
        if ($this->_request->getParam("json")) {
            $data['description_testimony'] = strval($this->_request->getParam("json"));
        }
