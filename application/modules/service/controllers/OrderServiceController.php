...
class Service_OrderServiceController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->view->title_page = "Ordem de Serviços";
        $this->view->description_page = "Gerencia recursos da sua empresa";

        $this->view->headLink();

        $this->view->headScript()
                ->appendFile("/public/modules/service/script.order-service.js");
    }

    public function detailsAction() {
        $this->_helper->layout->setLayout("layout_webapp");
        $this->view->id_module = 999;
        $this->view->title_page = "Ordem de Serviço";
        $this->view->description_page = "Gerencia recursos da sua empresa";
